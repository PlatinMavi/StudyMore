...
public class SyncModel {
    ...
    public Map<String, Object> getMultipliers() {
        return multipliers;
    }

    public void setMultipliers(Map<String, Object> multipliers) {
    ...
    public void setUserAchievements(List<Map<String, Object>> userAchievements) {
        this.userAchievements = userAchievements;
    }

    public List<Map<String, Object>> getTaskSrsHistory() {
        return taskSrsHistory;
    }

    public void setTaskSrsHistory(List<Map<String, Object>> taskSrsHistory) {
        this.taskSrsHistory = taskSrsHistory;
    }

    public List<Map<String, Object>> getInventoryOwnedItems() {
        return inventoryOwnedItems;
    }

    public void setInventoryOwnedItems(List<Map<String, Object>> inventoryOwnedItems) {
        this.inventoryOwnedItems = inventoryOwnedItems;
    }

    public List<Map<String, Object>> getInventoryEquippedItems() {
        return inventoryEquippedItems;
    }

    public void setInventoryEquippedItems(List<Map<String, Object>> inventoryEquippedItems) {
        this.inventoryEquippedItems = inventoryEquippedItems;
    }
    ...
    public void setFriendRequests(List<Map<String, Object>> friendRequests) {
    ...
    public void setStudyGroups(List<Map<String, Object>> studyGroups) {
