...
public class SyncService {
    ...
    public SyncModel exportUserData(Long userId) {
        ...
        payload.setUserAchievements(
                jdbcTemplate.queryForList("SELECT * FROM user_achievements WHERE user_id = ?", userId));
        ...
        payload.setFriends(jdbcTemplate.queryForList(
                ...
                userId, userId));
        payload.setFriendRequests(jdbcTemplate
                .queryForList("SELECT * FROM friend_requests WHERE sender_id = ? OR receiver_id = ?", userId, userId));
