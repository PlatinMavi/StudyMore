...
public class ProfileController {
    ...
    public void initialize() {
        ...
        multiplier.setText(
                String.format("%.1fX MULT", Main.mngr.getTodaysStudySession(Main.user).getMultiplier().getValue()));
        ...
        bannerImageView.setImage(
                new Image("/StudyMore/" + Main.user.getInventory().getEquipped(CosmeticType.BANNER).getImagePath()));
