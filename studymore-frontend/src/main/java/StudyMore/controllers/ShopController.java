...
public class ShopController {
    ...
    @FXML
    private HBox mascotCatsContainer;
    @FXML
    private HBox catHousesContainer;
    @FXML
    private HBox cosmeticsExtrasContainer;
    @FXML
    private VBox titlesContainer;
    @FXML
    ...
    private void loadShopUI() {
        ...
        // Check all containers after loading to see if the user has already bought
        // everything
    ...
    private Button createBuyButton(Cosmetic item, Pane card) {
        ...
        btn.setStyle(
                "-fx-background-color: transparent; -fx-text-fill: #fbbf24; -fx-border-color: #fbbf24; -fx-border-width: 1; -fx-border-radius: 4; -fx-background-radius: 4; -fx-font-weight: bold; -fx-padding: 7 15; -fx-cursor: hand;");
